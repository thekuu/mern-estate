  ...
  return (
    <div>
      <div className='flex flex-col gap-4 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-green-400 text-xs sm:text-sm'>Homi Estate is the best place to find your next perfect place to live. <br />
          We have a wide range of properties for you to choose from. 
        </div>
        <Link to = {'/search'} className='text-xs sm:text-sm before:text-blue-800 font-bold hover:underline'>
          Lets's get started...
        </Link>
      </div>
