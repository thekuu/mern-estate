  ...
  return (
    <main className='p-6 max-w-5xl mx-auto min-h-screen'>
      <div className='bg-white rounded-3xl shadow-xl shadow-slate-200 border border-slate-100 p-8 sm:p-12'>
        <div className='mb-10'>
          <h1 className='text-3xl font-black text-slate-900 mb-2 text-center'>Update Property</h1>
          <p className='text-slate-500 font-medium text-center'>Refresh your listing with new details and photos</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col lg:flex-row gap-12'>
          ...
          <div className='flex flex-col flex-1 gap-8'>
            <div className='space-y-4'>
              ...
              <div className='bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-8 text-center space-y-4 group hover:border-indigo-400 transition-colors'>
                <div className='flex flex-col items-center gap-2'>
                  ...
                  <p className='text-xs font-bold text-slate-500'>Add more or drop new photos</p>
                </div>
            ...
            <div className='pt-8 border-t border-slate-100 space-y-4'>
              <button disabled={loading || uploading} className='w-full bg-indigo-600 text-white rounded-2xl py-5 font-black uppercase hover:bg-indigo-700 disabled:opacity-50 transition-all shadow-xl shadow-indigo-100 active:scale-95 tracking-widest'>
