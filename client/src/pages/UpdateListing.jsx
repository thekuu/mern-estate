  ...
  return (
    <main className='p-6 max-w-5xl mx-auto min-h-screen'>
      <div className='bg-white rounded shadow-sm border border-[#DDE1E6] p-8 sm:p-12'>
        <div className='mb-10'>
          <h1 className='text-2xl font-bold text-[#111827] mb-1 text-center'>Update Property</h1>
          <p className='text-sm text-[#64748B] font-medium text-center'>Refresh your professional listing</p>
        </div>
